...
Public Class Form3
    ...
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Me.Click
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Me.Click
        Dim note As New Form4
        note.Show()
        Me.Hide()
    End Sub

    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Me.Click
        Dim note As New Form4
        note.Show()
        Me.Hide()
    End Sub
    ...
    Private Sub UserControl1_Click(sender As Object, e As EventArgs)
        ...
        Hide()
    End Sub
    Private Sub UserControl2_Click(sender As Object, e As EventArgs) Handles Me.Click
        Dim note As New Form4
        note.Show()
        Me.Hide()
    End Sub
